...
class Translator:
    ...
    def add_word(self, from_word, to_word):
        ...
        """
        english_to_german = {from_word:to_word}
    ...
    def translate(self, from_word):
        ...
        """
        translate_word = english_to_german(from_word)
...
def is_anagram(word1, word2):
    ...
    for x in word1 and word2:
        if x in word1[0] == word2[0]:
            return True
        else:
            return False
...
def earthquake_daily_summary():
    ...
    # print(data)
    for number in data['metadata']:
        print("Number of earthquakes: {}".format(data['count']))
