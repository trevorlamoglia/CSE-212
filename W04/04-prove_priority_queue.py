...
# Test 1
# Scenario: Add a node to the back of the queue
# Expected Result: Display an added node according to priority
print("Test 1")
node = Priority_Queue()
node.enqueue(2, 1)
node.enqueue(4, 2)
...
# Test 2
# Scenario: Remove the node with the highest priority and return its value
# Expected Result: Display the removed node with the highest priority with its value
print("Test 2")
node = Priority_Queue()
node.enqueue(2, 1)
node.enqueue(4, 2)
